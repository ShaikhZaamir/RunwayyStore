        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            {status === "authenticated" ? (
              <Link
                href="/profile"
                className="p-2 hover:bg-secondary rounded-md transition flex items-center gap-2"
              >
              ...
              <Link
                href="/login"
                className="hidden sm:block px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition font-semibold"
              >
                Login
              </Link>
            )}
